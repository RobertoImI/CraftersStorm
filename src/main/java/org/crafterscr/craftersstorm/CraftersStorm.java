...
public final class CraftersStorm {
    ...
    private void death(LivingDeathEvent e) { if (match != null) match.death(e); }
    private void incoming(LivingIncomingDamageEvent e) { if (match != null) match.incoming(e); }
    private void damaged(LivingDamageEvent.Post e) { if (match != null) match.damaged(e); }
